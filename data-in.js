// --- DATA BAHASA INDONESIA (data-in.js) ---
...
const BUS_DATA = [
    ...
    ["Plaza Pusat",[-497,481]], ["Hutan",[-500,798]]
];

// 4. TOKO
const SHOP_DATA = [
    [-472,487,"Pakaian","vetement.png"],[-474,503,"Perabot","Meuble.png"],
...
// 6. LOKASI
const LIEUX_DATA = [
    {pos:[-538,492], name:"Plaza Pusat", type:"label-ville", startOn:true}, 
    ...
    {pos:[-725,208], name:"Pantai Violet", type:"label-ville", startOn:true}, 
    ...
    {pos:[-669,368], name:"Sungai Sunyi", type:"label-eau", startOn:true}, 
...
const resourcesData = {
    ...
    "Truffle Hitam": { icon: "resource/truffes noires.png", positions: [[-358.1, 911.1], [-357.4, 926.1], [-340.4, 913.6], [-325.8, 920], [-342.1, 956.5], [-363.3, 961.8]] },
    ...
    "Jamur Mousseron": { icon: "resource/mousseron.png", positions: [[-676.3, 271.5], [-667.8, 264], [-686.3, 260.8], [-706.3, 253.5], [-632.8, 247.3], [-601.3, 229.5], [-577.5, 242.8], [-553.5, 237.3], [-491.8, 177.8], [-480.5, 192.5], [-459.8, 225.8], [-440.3, 230.3], [-420.3, 202.8], [-408.3, 178.8]] },
    "Jamur Tiram": { icon: "resource/pleurote.png", positions: [[-220.5, 355.3], [-207.5, 352.6], [-145.3, 303], [-162.5, 296], [-190.5, 294.3], [-210.3, 301.8], [-221.3, 310], [-214, 421.1], [-196.1, 428.4], [-174.4, 399.8], [-212.6, 470.8], [-232.5, 522.3], [-205.8, 512.4], [-194.9, 526.1], [-169, 510.6], [-167.9, 533.9], [-186, 547.6], [-189.3, 583.9]] }
};

// 8. DAFTAR IKAN
const fishList = [
    {name:"Ikan Bleak", bg:"condition/ablette_lieu.png", cond:"condition/ablette_meteo.png", heure:"condition/ablette_heure.png"},
    ...
    {name:"Ikan Bonito", bg:"condition/bonite_lieu.png", cond:"condition/bonite_meteo.png", heure:"condition/bonite_heure.png"},
    {name:"Pike Bertotol", bg:"condition/brochet_tachete_lieu.png", cond:"condition/brochet_tachete_meteo.png", heure:"condition/brochet_tachete_heure.png"},
    ...
    {name:"Lobster Air Tawar", bg:"condition/ecrevisse_noble_lieu.png", cond:"condition/ecrevisse_noble_meteo.png", heure:"condition/ecrevisse_noble_heure.png"},
    {name:"Lobster Biru", bg:"condition/ecrevisse_noble_bleue_lieu.png", cond:"condition/ecrevisse_noble_bleue_meteo.png", heure:"condition/ecrevisse_noble_bleue_heure.png"},
    ...
    {name:"Bass Mulut Besar", bg:"condition/grand_blackbasse_lieu.png", cond:"condition/grand_blackbasse_meteo.png", heure:"condition/grand_blackbasse_heure.png"},
    ...
    {name:"Ikan Huchen", bg:"condition/huchon_lieu.png", cond:"condition/huchon_meteo.png", heure:"condition/huchon_heure.png"},
    ...
    {name:"Ikan Loach Bunga", bg:"condition/loche_des_fleurs_lieu.png", cond:"condition/loche_des_fleurs_meteo.png", heure:"condition/loche_des_fleurs_heure.png"},
    {name:"Ikan Loach Batu", bg:"condition/loche_des_rochers_lieu.png", cond:"condition/loche_des_rochers_meteo.png", heure:"condition/loche_des_rochers_heure.png"},
    {name:"Ikan Burbot", bg:"condition/lotte_lieu.png", cond:"condition/lotte_meteo.png", heure:"condition/lotte_heure.png"},
    ...
    {name:"Ikan Char Arktik", bg:"condition/omble_chevalier_lieu.png", cond:"condition/omble_chevalier_meteo.png", heure:"condition/omble_chevalier_heure.png"},
    {name:"Ikan Drum", bg:"condition/ombrine_lieu.png", cond:"condition/ombrine_meteo.png", heure:"condition/ombrine_heure.png"},
    {name:"Ikan Seabream", bg:"condition/pagellus_bogaraveo_lieu.png", cond:"condition/pagellus_bogaraveo_meteo.png", heure:"condition/pagellus_bogaraveo_heure.png"},
    {name:"Ikan Kakap Putih", bg:"condition/perche_de_mer_lieu.png", cond:"condition/perche_de_mer_meteo.png", heure:"condition/perche_de_mer_heure.png"},
    {name:"Ikan Perch Plum", bg:"condition/perche_de_prunier_lieu.png", cond:"condition/perche_de_prunier_meteo.png", heure:"condition/perche_de_prunier_heure.png"},
    {name:"Ikan Perch Sungai", bg:"condition/perche_de_riviere_lieu.png", cond:"condition/perche_de_riviere_meteo.png", heure:"condition/perche_de_riviere_heure.png"},
    ...
    {name:"Ikan Plaice", bg:"condition/plie_europeenne_lieu.png", cond:"condition/plie_europeenne_meteo.png", heure:"condition/plie_europeenne_heure.png"},
    ...
    {name:"Ikan Stickleback", bg:"condition/poisson_epineux_lieu.png", cond:"condition/poisson_epineux_meteo.png", heure:"condition/poisson_epineux_heure.png"},
    ...
    {name:"Ikan Layur", bg:"condition/poisson_ruban_lieu.png", cond:"condition/poisson_ruban_meteo.png", heure:"condition/poisson_ruban_heure.png"},
    {name:"Ikan Mata Merah", bg:"condition/poisson_a_yeux_rouges_lieu.png", cond:"condition/poisson_a_yeux_rouges_meteo.png", heure:"condition/poisson_a_yeux_rouges_heure.png"},
    {name:"Ikan Oarfish", bg:"condition/regalec_lieu.png", cond:"condition/regalec_meteo.png", heure:"condition/regalec_heure.png"},
    {name:"Ikan Belanak Merah", bg:"condition/rouget_barbet_lieu.png", cond:"condition/rouget_barbet_meteo.png", heure:"condition/rouget_barbet_heure.png"},
    {name:"Hiu Kucing", bg:"condition/roussette_lieu.png", cond:"condition/roussette_meteo.png", heure:"condition/roussette_heure.png"},
    {name:"Ikan Zander Putih", bg:"condition/sandre_blanc_lieu.png", cond:"condition/sandre_blanc_meteo.png", heure:"condition/sandre_blanc_heure.png"},
    ...
    {name:"Ikan Saurel", bg:"condition/saurel_lieu.png", cond:"condition/saurel_meteo.png", heure:"condition/saurel_heure.png"},
    ...
    {name:"Ikan Lele Wels", bg:"condition/silure_europeen_lieu.png", cond:"condition/silure_europeen_meteo.png", heure:"condition/silure_europeen_heure.png"},
    {name:"Ikan Tench Emas", bg:"condition/tanche_doree_lieu.png", cond:"condition/tanche_doree_meteo.png", heure:"condition/tanche_doree_heure.png"},
    {name:"Berudu", bg:"condition/tetard_lieu.png", cond:"condition/tetard_meteo.png", heure:"condition/tetard_heure.png"},
    {name:"Ikan Nila", bg:"condition/tilapia_lieu.png", cond:"condition/tilapia_meteo.png", heure:"condition/tilapia_heure.png"},
    {name:"Ikan Turbot", bg:"condition/turbot_lieu.png", cond:"condition/turbot_meteo.png", heure:"condition/turbot_heure.png"},
...
const bugList = [
    ...
    {name:"Ngengat Bulan Cina", bg:"condition/actias_neidhoederi_lieu.png", cond:"condition/actias_neidhoederi_meteo.png", heure:"condition/actias_neidhoederi_heure.png"},
    ...
    {name:"Kumbang Harimau", bg:"condition/capricorne_tigre_lieu.png", cond:"condition/capricorne_tigre_meteo.png", heure:"condition/capricorne_tigre_heure.png"},
    ...
    {name:"Jangkrik", bg:"condition/cigale_lieu.png", cond:"condition/cigale_meteo.png", heure:"condition/cigale_heure.png"},
    ...
    {name:"Kumbang Koksi 7 Titik", bg:"condition/coccinelle_a_sept_points_lieu.png", cond:"condition/coccinelle_a_sept_points_meteo.png", heure:"condition/coccinelle_a_sept_points_heure.png"},
    {name:"Kumbang Koksi Asia", bg:"condition/coccinelle_asiatique_lieu.png", cond:"condition/coccinelle_asiatique_meteo.png", heure:"condition/coccinelle_asiatique_heure.png"},
    ...
    {name:"Belalang Bersayap", bg:"condition/criquet_a_ailes_reticulees_lieu.png", cond:"condition/criquet_a_ailes_reticulees_meteo.png", heure:"condition/criquet_a_ailes_reticulees_heure.png"},
    {name:"Belalang Kaki Tebal", bg:"condition/criquet_aux_pattes_massives_lieu.png", cond:"condition/criquet_aux_pattes_massives_meteo.png", heure:"condition/criquet_aux_pattes_massives_heure.png"},
    ...
    {name:"Jangkrik", bg:"condition/grillon_lieu.png", cond:"condition/grillon_meteo.png", heure:"condition/grillon_heure.png"},
    ...
    {name:"Kupu-kupu Fritillary", bg:"condition/melitee_leopard_lieu.png", cond:"condition/melitee_leopard_meteo.png", heure:"condition/melitee_leopard_heure.png"},
    ...
    {name:"Kupu-kupu Apollo", bg:"condition/parnassien_lieu.png", cond:"condition/parnassien_meteo.png", heure:"condition/parnassien_heure.png"},
    {name:"Kupu-kupu Kecil Putih", bg:"condition/pieride_du_cresson_lieu.png", cond:"condition/pieride_du_cresson_meteo.png", heure:"condition/pieride_du_cresson_heure.png"},
    ...
    {name:"Belalang Merah Muda", bg:"condition/sauterelle_rose_lieu.png", cond:"condition/sauterelle_rose_meteo.png", heure:"condition/sauterelle_rose_heure.png"},
    ...
    {name:"Kupu-kupu Kaisar Ungu", bg:"condition/Vanesse_violette_lieu.png", cond:"condition/Vanesse_violette_meteo.png", heure:"condition/Vanesse_violette_heure.png"}
];
...
const birdList = [
    ...
    {name:"Burung Wagtail Putih", bg:"condition/bergeronnette_grise_lieu.png", cond:"condition/bergeronnette_grise_meteo.png", heure:"condition/bergeronnette_grise_heure.png"},
    {name:"Burung Bullfinch", bg:"condition/bouvreuil_lieu.png", cond:"condition/bouvreuil_meteo.png", heure:"condition/bouvreuil_heure.png"},
    ...
    {name:"Tanager Kepala Hijau", bg:"condition/calliste_septicolore_lieu.png", cond:"condition/calliste_septicolore_meteo.png", heure:"condition/calliste_septicolore_heure.png"},
    ...
    {name:"Kardinal Jambul Abu", bg:"condition/cardinal_a_couronne_grisecolombar_a_cou_rose_lieu.png", cond:"condition/cardinal_a_couronne_grisecolombar_a_cou_rose_meteo.png", heure:"condition/cardinal_a_couronne_grisecolombar_a_cou_rose_heure.png"},
    ...
    {name:"Bebek Eider Raja", bg:"condition/eider_royal_lieu.png", cond:"condition/eider_royal_meteo.png", heure:"condition/eider_royal_heure.png"},
    {name:"Burung Pegar Lady Amherst", bg:"condition/faisan_a_ventre_blanc_lieu.png", cond:"condition/faisan_a_ventre_blanc_meteo.png", heure:"condition/faisan_a_ventre_blanc_heure.png"},
    {name:"Elang Kaki Merah", bg:"condition/faucon_a_pattes_rouges_lieu.png", cond:"condition/faucon_a_pattes_rouges_meteo.png", heure:"condition/faucon_a_pattes_rouges_heure.png"},
    ...
    {name:"Elang Merah", bg:"condition/faucon_rouge_lieu.png", cond:"condition/faucon_rouge_meteo.png", heure:"condition/faucon_rouge_heure.png"},
    ...
    {name:"Burung Chaffinch", bg:"condition/fringilla_coelebs_lieu.png", cond:"condition/fringilla_coelebs_meteo.png", heure:"condition/fringilla_coelebs_heure.png"},
    ...
    {name:"Pelatuk Jambul", bg:"condition/grand_pic_lieu.png", cond:"condition/grand_pic_meteo.png", heure:"condition/grand_pic_heure.png"},
    {name:"Burung Hawfinch", bg:"condition/grosbec_lieu.png", cond:"condition/grosbec_meteo.png", heure:"condition/grosbec_heure.png"},
    {name:"Pemakan Lebah Eropa", bg:"condition/guepier_deurope_lieu.png", cond:"condition/guepier_deurope_meteo.png", heure:"condition/guepier_deurope_heure.png"},
    {name:"Bebek Smew", bg:"condition/harle_piette_lieu.png", cond:"condition/harle_piette_meteo.png", heure:"condition/harle_piette_heure.png"},
    ...
    {name:"Burung Twite", bg:"condition/linotte_a_dos_blanc_lieu.png", cond:"condition/linotte_a_dos_blanc_meteo.png", heure:"condition/linotte_a_dos_blanc_heure.png"},
    ...
    {name:"Reedling Berkumis", bg:"condition/panure_a_moustache_lieu.png", cond:"condition/panure_a_moustache_meteo.png", heure:"condition/panure_a_moustache_heure.png"},
    ...
    {name:"Shrike Woodchat", bg:"condition/piegrieche_a_tete_rousse_lieu.png", cond:"condition/piegrieche_a_tete_rousse_meteo.png", heure:"condition/piegrieche_a_tete_rousse_heure.png"},
    {name:"Merpati Buah Perut Oranye", bg:"condition/pigeon_aux_fruits_dor_lieu.png", cond:"condition/pigeon_aux_fruits_dor_meteo.png", heure:"condition/pigeon_aux_fruits_dor_heure.png"},
    ...
    {name:"Merpati Stock", bg:"condition/pigeon_colombin_lieu.png", cond:"condition/pigeon_colombin_meteo.png", heure:"condition/pigeon_colombin_heure.png"},
    ...
    {name:"Burung Finch", bg:"condition/pinson_lieu.png", cond:"condition/pinson_meteo.png", heure:"condition/pinson_heure.png"},
    ...
    {name:"Bebek Ruddy Shelduck", bg:"condition/tadorne_casarca_lieu.png", cond:"condition/tadorne_casarca_meteo.png", heure:"condition/tadorne_casarca_heure.png"},
    {name:"Merpati Kepala Abu", bg:"condition/tourterelle_a_tete_grise_lieu.png", cond:"condition/tourterelle_a_tete_grise_meteo.png", heure:"condition/tourterelle_a_tete_grise_heure.png"},
    {name:"Merpati Berkalung", bg:"condition/tourterelle_grise_lieu.png", cond:"condition/tourterelle_grise_meteo.png", heure:"condition/tourterelle_grise_heure.png"},
    {name:"Merpati Tutul", bg:"condition/tourterelle_tigrine_lieu.png", cond:"condition/tourterelle_tigrine_meteo.png", heure:"condition/tourterelle_tigrine_heure.png"},
    {name:"Burung Wren", bg:"condition/troglodyte_lieu.png", cond:"condition/troglodyte_meteo.png", heure:"condition/troglodyte_heure.png"}
];

// 11. KUIS
const QUIZ_DATA = [
    { q: "Siapa pembeli di desa?", o: ["Albert Jr.", "Ka Ching", "Eric"], a: 0 },
    { q: "Di mana Anda bisa menemukan Acantharchus pomotis?", o: ["Laut Tenang", "Danau Hutan", "Sungai Aurora"], a: 0 },
    ...
    { q: "Di mana Desa Nelayan?", o: ["Timur Laut", "Barat Daya", "Timur"], a: 1 },
    { q: "Kapan Ngengat Bulan Cina muncul?", o: ["Pagi", "Siang", "Malam"], a: 2 },
    ...
    { q: "Di mana menangkap Ikan Oarfish?", o: ["Sungai", "Danau", "Laut"], a: 2 },
    { q: "Di mana area Pemandian Air Panas?", o: ["Utara", "Selatan", "Barat"], a: 0 },
    { q: "Di mana Kumbang Unicorn tinggal?", o: ["Dermaga Timur", "Ladang", "Hutan"], a: 0 },
    { q: "Apa itu Macaw Indigo?", o: ["Ikan", "Serangga", "Burung"], a: 2 },
    { q: "Di mana Ikan Mas Kupu-kupu tinggal?", o: ["Air Tawar", "Air Asin", "Danau Padang Rumput"], a: 2 },
    { q: "Di mana NPC Will?", o: ["Dekat laut", "Di pegunungan", "Di hutan"], a: 0 },
    { q: "Apa warna tombol IKAN?", o: ["Hijau", "Biru", "Oranye"], a: 1 },
    { q: "Di mana Kumbang Bumblebee tinggal?", o: ["Danau", "Ladang Bunga", "Gua"], a: 1 },
    { q: "Di mana Berang-berang?", o: ["Mercusuar", "Desa Nelayan", "Reruntuhan"], a: 1 },
    { q: "Di dekat mana Panda tinggal?", o: ["Papan Loncat", "Desa", "Dermaga"], a: 0 },
    { q: "Di mana Ikan Smelt tinggal?", o: ["Danau Padang Rumput", "Danau Hutan Atas", "Laut"], a: 0 },
    { q: "Di mana Annie?", o: ["Plaza Pusat", "Pantai", "Hutan"], a: 0 },
    { q: "Di mana Llama tinggal?", o: ["Pantai Violet", "Gunung", "Sungai"], a: 0 },
    { q: "Berapa nilai peta dari 20?", o: ["5", "0", "20"], a: 2 },
    { q: "Di mana Lobster Biru tinggal?", o: ["Danau Hutan", "Laut", "Laut Tenang"], a: 0 },
    { q: "Di mana Gunung Paus?", o: ["Selatan", "Utara", "Barat"], a: 2 },
    { q: "Apa gunanya Maptopia?", o: ["Menjual barang", "Mencari sumber daya", "Menggantikan permainan"], a: 1 },
    { q: "Apa itu Burung Wagtail Putih?", o: ["Burung", "Ikan", "Penduduk"], a: 1 },
    { q: "Di mana Rusa tinggal?", o: ["Pantai", "Hutan Oak", "Kota"], a: 1 },
    { q: "Apa itu Kupu-kupu Brimstone?", o: ["Buah", "Serangga", "Ikan"], a: 1 },
    { q: "Di mana Dermaga Timur?", o: ["Utara", "Timur", "Selatan"], a: 1 },
    { q: "Apa itu Bob?", o: ["Hewan", "NPC", "Tempat"], a: 1 }
];
