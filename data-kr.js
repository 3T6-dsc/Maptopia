...
const TEXTS = {
    ...
    quiz: {
        ...
        error: "❌ 오답!",
        finishTitle: "🏆 전문가 인증!",
        finishText: "당신은 Heartopia를 완벽하게 알고 있습니다.",
        quitBtn: "퀴즈 종료"
    },
    like: {
        thankyou: "감사합니다!",
...
const PNJ_DATA = [
    ...
    [-502, 519, "조안 여사", "pnj/mme joan.png"],
    ...
    [-532.4, 634.8, "알버트 Jr.", "pnj/albert jr.png"],
...
// 3. 버스 정류장
const BUS_DATA = [
    ["서쪽 교외",[-533,340]], ["교외 마을",[-519,639]], ["어부 마을",[-654,479]], 
...
// 4. 상점
const SHOP_DATA = [
    [-472,487,"의류점","vetement.png"],[-474,503,"가구점","Meuble.png"],
...
const LIEUX_DATA = [
    ...
    {pos:[-692,506], name:"어부 마을", type:"label-ville", startOn:true}, 
    ...
    {pos:[-725,208], name:"바이올렛 해변", type:"label-ville", startOn:true}, 
    ...
    {pos:[-431,774], name:"숲 위 호수", type:"label-eau", startOn:true}, 
    {pos:[-608,481], name:"교외 호수", type:"label-eau", startOn:true}, 
    {pos:[-669,368], name:"조용한 강", type:"label-eau", startOn:true}, 
    {pos:[-674,627], name:"거대한 나무 강", type:"label-eau", startOn:true}, 
...
const resourcesData = {
    ...
    "그물버섯 (포르치니)": { icon: "resource/cépes de bordeaux.png", positions: [[-615, 796.9], [-620, 778.1], [-610.6, 759.9], [-634.9, 745.5], [-650, 773.5], [-639, 800.6], [-543.5, 776.3], [-523.6, 777], [-524.3, 818.9], [-479.9, 780.8], [-464.3, 775.6], [-472.1, 801], [-477.3, 825.8], [-438.4, 789.3], [-410.5, 776.8], [-404.1, 794.1], [-415.8, 799.1]] },
    ...
    "송이버섯류": { icon: "resource/mousseron.png", positions: [[-676.3, 271.5], [-667.8, 264], [-686.3, 260.8], [-706.3, 253.5], [-632.8, 247.3], [-601.3, 229.5], [-577.5, 242.8], [-553.5, 237.3], [-491.8, 177.8], [-480.5, 192.5], [-459.8, 225.8], [-440.3, 230.3], [-420.3, 202.8], [-408.3, 178.8]] },
...
const fishList = [
    ...
    {name:"진흙개복치", bg:"condition/acantharchus_pomotis_lieu.png", cond:"condition/acantharchus_pomotis_meteo.png", heure:"condition/acantharchus_pomotis_heure.png"},
    ...
    {name:"수염고기 (바벨)", bg:"condition/barbeau_lieu.png", cond:"condition/barbeau_meteo.png", heure:"condition/barbeau_heure.png"},
    ...
    {name:"점박이 강꼬치고기", bg:"condition/brochet_tachete_lieu.png", cond:"condition/brochet_tachete_meteo.png", heure:"condition/brochet_tachete_heure.png"},
    {name:"백연어", bg:"condition/carpe_argente_lieu.png", cond:"condition/carpe_argente_meteo.png", heure:"condition/carpe_argente_heure.png"},
    {name:"유럽 잉어", bg:"condition/carpe_europeenne_lieu.png", cond:"condition/carpe_europeenne_meteo.png", heure:"condition/carpe_europeenne_heure.png"},
    ...
    {name:"민물 게", bg:"condition/crabe_de_ruisseau_lieu.png", cond:"condition/crabe_de_ruisseau_meteo.png", heure:"condition/crabe_de_ruisseau_heure.png"},
    ...
    {name:"푸른 가재", bg:"condition/ecrevisse_noble_bleue_lieu.png", cond:"condition/ecrevisse_noble_bleue_meteo.png", heure:"condition/ecrevisse_noble_bleue_heure.png"},
    ...
    {name:"송어 (Fera)", bg:"condition/fera_lieu.png", cond:"condition/fera_meteo.png", heure:"condition/fera_heure.png"},
    ...
    {name:"성대 (Gurnard)", bg:"condition/grondin_perlon_lieu.png", cond:"condition/grondin_perlon_meteo.png", heure:"condition/grondin_perlon_heure.png"},
    {name:"해마", bg:"condition/hippocampe_lieu.png", cond:"condition/hippocampe_meteo.png", heure:"condition/hippocampe_heure.png"},
    {name:"후첸 (다뉴브 연어)", bg:"condition/huchon_lieu.png", cond:"condition/huchon_meteo.png", heure:"condition/huchon_heure.png"},
    ...
    {name:"모오케 (Burbot)", bg:"condition/lotte_lieu.png", cond:"condition/lotte_meteo.png", heure:"condition/lotte_heure.png"},
    ...
    {name:"검은점 도미", bg:"condition/pagellus_bogaraveo_lieu.png", cond:"condition/pagellus_bogaraveo_meteo.png", heure:"condition/pagellus_bogaraveo_heure.png"},
    {name:"농어 (Sea Bass)", bg:"condition/perche_de_mer_lieu.png", cond:"condition/perche_de_mer_meteo.png", heure:"condition/perche_de_mer_heure.png"},
    {name:"매실 농어", bg:"condition/perche_de_prunier_lieu.png", cond:"condition/perche_de_prunier_meteo.png", heure:"condition/perche_de_prunier_heure.png"},
    ...
    {name:"대서양 피그미 문어", bg:"condition/pieuvre_naine_atlantique_lieu.png", cond:"condition/pieuvre_naine_atlantique_meteo.png", heure:"condition/pieuvre_naine_atlantique_heure.png"},
    ...
    {name:"노랑촉수 (Red Mullet)", bg:"condition/rouget_barbet_lieu.png", cond:"condition/rouget_barbet_meteo.png", heure:"condition/rouget_barbet_heure.png"},
    {name:"두툽상어", bg:"condition/roussette_lieu.png", cond:"condition/roussette_meteo.png", heure:"condition/roussette_heure.png"},
    {name:"흰 잔더", bg:"condition/sandre_blanc_lieu.png", cond:"condition/sandre_blanc_meteo.png", heure:"condition/sandre_blanc_heure.png"},
    ...
    {name:"첨 연어", bg:"condition/saumon_keta_lieu.png", cond:"condition/saumon_keta_meteo.png", heure:"condition/saumon_keta_heure.png"},
    ...
    {name:"대문짝넙치 (Turbot)", bg:"condition/turbot_lieu.png", cond:"condition/turbot_meteo.png", heure:"condition/turbot_heure.png"},
    {name:"피라미류 (Minnow)", bg:"condition/vairon_lieu.png", cond:"condition/vairon_meteo.png", heure:"condition/vairon_heure.png"},
    {name:"징겔", bg:"condition/zingel_streber_lieu.png", cond:"condition/zingel_streber_meteo.png", heure:"condition/zingel_streber_heure.png"}
];
...
const bugList = [
    ...
    {name:"파란 어리호박벌", bg:"condition/Abeille_charpentière_bleue_lieu.png", cond:"condition/Abeille_charpentière_bleue_meteo.png", heure:"condition/Abeille_charpentière_bleue_heure.png"},
    {name:"보라 어리호박벌", bg:"condition/abeille_charpentiere_violette_lieu.png", cond:"condition/abeille_charpentiere_violette_meteo.png", heure:"condition/abeille_charpentiere_violette_heure.png"},
    ...
    {name:"호랑가시 푸른부전나비", bg:"condition/azure_de_porcelaine_lieu.png", cond:"condition/azure_de_porcelaine_meteo.png", heure:"condition/azure_de_porcelaine_heure.png"},
    {name:"호박벌", bg:"condition/bourdon_lieu.png", cond:"condition/bourdon_meteo.png", heure:"condition/bourdon_heure.png"},
    {name:"호랑이 하늘소", bg:"condition/capricorne_tigre_lieu.png", cond:"condition/capricorne_tigre_meteo.png", heure:"condition/capricorne_tigre_heure.png"},
    ...
    {name:"초록 길앞잡이", bg:"condition/cicindele_verte_lieu.png", cond:"condition/cicindele_verte_meteo.png", heure:"condition/cicindele_verte_heure.png"},
    ...
    {name:"그물 날개 메뚜기", bg:"condition/criquet_a_ailes_reticulees_lieu.png", cond:"condition/criquet_a_ailes_reticulees_meteo.png", heure:"condition/criquet_a_ailes_reticulees_heure.png"},
    {name:"굵은 다리 메뚜기", bg:"condition/criquet_aux_pattes_massives_lieu.png", cond:"condition/criquet_aux_pattes_massives_meteo.png", heure:"condition/criquet_aux_pattes_massives_heure.png"},
    {name:"개미", bg:"condition/fourmi_lieu.png", cond:"condition/fourmi_meteo.png", heure:"condition/fourmi_heure.png"},
    {name:"큰 실잠자리", bg:"condition/grand_agrion_lieu.png", cond:"condition/grand_agrion_meteo.png", heure:"condition/grand_agrion_heure.png"},
    {name:"귀뚜라미", bg:"condition/grillon_lieu.png", cond:"condition/grillon_meteo.png", heure:"condition/grillon_heure.png"},
    {name:"흰 꼬리 잠자리", bg:"condition/libellule_a_queue_blanche_lieu.png", cond:"condition/libellule_a_queue_blanche_meteo.png", heure:"condition/libellule_a_queue_blanche_heure.png"},
    ...
    {name:"아폴로 나비", bg:"condition/parnassien_lieu.png", cond:"condition/parnassien_meteo.png", heure:"condition/parnassien_heure.png"},
    {name:"작은 흰나비", bg:"condition/pieride_du_cresson_lieu.png", cond:"condition/pieride_du_cresson_meteo.png", heure:"condition/pieride_du_cresson_heure.png"},
    ...
    {name:"불개미", bg:"condition/pyrrhocoris_apterus_lieu.png", cond:"condition/pyrrhocoris_apterus_meteo.png", heure:"condition/pyrrhocoris_apterus_heure.png"},
    ...
    {name:"분홍 메뚜기", bg:"condition/sauterelle_rose_lieu.png", cond:"condition/sauterelle_rose_meteo.png", heure:"condition/sauterelle_rose_heure.png"},
    ...
    {name:"보라 황제 나비", bg:"condition/Vanesse_violette_lieu.png", cond:"condition/Vanesse_violette_meteo.png", heure:"condition/Vanesse_violette_heure.png"}
];
...
const birdList = [
    ...
    {name:"일곱색깔 풍금조", bg:"condition/calliste_septicolore_lieu.png", cond:"condition/calliste_septicolore_meteo.png", heure:"condition/calliste_septicolore_heure.png"},
    ...
    {name:"킹 아이더 오리", bg:"condition/eider_royal_lieu.png", cond:"condition/eider_royal_meteo.png", heure:"condition/eider_royal_heure.png"},
    ...
    {name:"송골매", bg:"condition/faucon_pelerin_lieu.png", cond:"condition/faucon_pelerin_meteo.png", heure:"condition/faucon_pelerin_heure.png"},
    ...
    {name:"가막딱따구리", bg:"condition/grand_pic_lieu.png", cond:"condition/grand_pic_meteo.png", heure:"condition/grand_pic_heure.png"},
    ...
    {name:"황금 정원사새", bg:"condition/jardinier_a_tete_jaune_lieu.png", cond:"condition/jardinier_a_tete_jaune_meteo.png", heure:"condition/jardinier_a_tete_jaune_heure.png"},
    {name:"트와이트", bg:"condition/linotte_a_dos_blanc_lieu.png", cond:"condition/linotte_a_dos_blanc_meteo.png", heure:"condition/linotte_a_dos_blanc_heure.png"},
    ...
    {name:"은빛 턱 박새", bg:"condition/mesange_a_menton_argent_lieu.png", cond:"condition/mesange_a_menton_argent_meteo.png", heure:"condition/mesange_a_menton_argent_heure.png"},
    ...
    {name:"검은 머리 갈매기", bg:"condition/mouette_lieu.png", cond:"condition/mouette_meteo.png", heure:"condition/mouette_heure.png"},
    ...
    {name:"녹공작", bg:"condition/paon_vert_lieu.png", cond:"condition/paon_vert_meteo.png", heure:"condition/paon_vert_heure.png"},
    {name:"작은 홍학", bg:"condition/petit_flamant_lieu.png", cond:"condition/petit_flamant_meteo.png", heure:"condition/petit_flamant_heure.png"},
    {name:"붉은 머리 때까치", bg:"condition/piegrieche_a_tete_rousse_lieu.png", cond:"condition/piegrieche_a_tete_rousse_meteo.png", heure:"condition/piegrieche_a_tete_rousse_heure.png"},
    {name:"오렌지 배 과일 비둘기", bg:"condition/pigeon_aux_fruits_dor_lieu.png", cond:"condition/pigeon_aux_fruits_dor_meteo.png", heure:"condition/pigeon_aux_fruits_dor_heure.png"},
    ...
    {name:"울새 (로빈)", bg:"condition/rougegorge_lieu.png", cond:"condition/rougegorge_meteo.png", heure:"condition/rougegorge_heure.png"},
...
// 11. 퀴즈
const QUIZ_DATA = [
    { q: "마을의 구매자는 누구인가요?", o: ["알버트 Jr.", "카칭", "에릭"], a: 0 },
    { q: "진흙개복치는 어디서 찾나요?", o: ["고요한 바다", "숲 호수", "오로라 강"], a: 0 },
    { q: "수집품을 관리하는 NPC는?", o: ["수집가", "밥", "마시모"], a: 0 },
    { q: "무지개가 뜨는 날씨는?", o: ["폭풍", "안개", "비 온 뒤 맑음"], a: 2 },
    { q: "어부 마을은 어디인가요?", o: ["북동쪽", "남서쪽", "동쪽"], a: 1 },
    { q: "긴꼬리산누에나방은 언제 나타나요?", o: ["아침", "낮", "밤"], a: 2 },
    { q: "카피바라는 어디에 사나요?", o: ["유적지", "다이빙 대", "해변"], a: 0 },
    { q: "누가 동물(개)을 파나요?", o: ["버니", "조안 여사", "앤드류"], a: 1 },
    { q: "산갈치는 어디서 잡나요?", o: ["강", "호수", "바다"], a: 2 },
    { q: "온천 지역은 어디인가요?", o: ["북쪽", "남쪽", "서쪽"], a: 0 },
    { q: "장수풍뎅이는 어디에 사나요?", o: ["동쪽 부두", "들판", "숲"], a: 0 },
    { q: "인디고 마코앵무는 무엇인가요?", o: ["물고기", "곤충", "새"], a: 2 },
    ...
    { q: "수달은 어디에 있나요?", o: ["등대", "어부 마을", "유적지"], a: 1 },
    { q: "판다는 어디 근처에 사나요?", o: ["다이빙 대", "마을", "부두"], a: 0 },
    { q: "빙어는 어디에 사나요?", o: ["초원 호수", "숲 위 호수", "바다"], a: 0 },
    { q: "애니는 어디에 있나요?", o: ["중앙 광장", "해변", "숲"], a: 0 },
    { q: "라마는 어디에 사나요?", o: ["바이올렛 해변", "산", "강"], a: 0 },
    { q: "지도의 평점은 20점 만점에?", o: ["5", "0", "20"], a: 2 },
    { q: "푸른 가재는 어디에 사나요?", o: ["숲 호수", "바다", "고요한 바다"], a: 0 },
    { q: "고래 산은 어디에 있나요?", o: ["남쪽", "북쪽", "서쪽"], a: 2 },
    { q: "Maptopia의 용도는?", o: ["물건 팔기", "자원 찾기", "게임 대체"], a: 1 },
    { q: "알락할미새는 무엇인가요?", o: ["새", "물고기", "주민"], a: 1 },
    { q: "사슴은 어디에 사나요?", o: ["해변", "오크 숲", "도시"], a: 1 },
    { q: "갈고리 나비는 무엇인가요?", o: ["과일", "곤충", "물고기"], a: 1 },
    { q: "동쪽 부두는 어디인가요?", o: ["북쪽", "동쪽", "남쪽"], a: 1 },
