...
const BUS_DATA = [
    ...
    ["Blumenfelder",[-532,218]], ["Thermalberg",[-222,512]], ["Nördliche Vorstadt",[-373,480]], 
...
const SHOP_DATA = [
    ...
    [-496.4,520.6,"Haustiere","chien.png"],[-440,467,"Buchhandlung","Librairie.png"]
];
...
const LIEUX_DATA = [
    ...
    {pos:[-674,627], name:"Riesenbaumfluss", type:"label-eau", startOn:true}, 
    {pos:[-600,600], name:"Windmühlen-Blumenfeld", type:"label-ville", startOn:true}, 
...
const resourcesData = {
    ...
    "Steinpilz": { icon: "resource/cépes de bordeaux.png", positions: [[-615, 796.9], [-620, 778.1], [-610.6, 759.9], [-634.9, 745.5], [-650, 773.5], [-639, 800.6], [-543.5, 776.3], [-523.6, 777], [-524.3, 818.9], [-479.9, 780.8], [-464.3, 775.6], [-472.1, 801], [-477.3, 825.8], [-438.4, 789.3], [-410.5, 776.8], [-404.1, 794.1], [-415.8, 799.1]] },
    "Schwarze Trüffel": { icon: "resource/truffes noires.png", positions: [[-358.1, 911.1], [-357.4, 926.1], [-340.4, 913.6], [-325.8, 920], [-342.1, 956.5], [-363.3, 961.8]] },
    ...
    "Maipilz": { icon: "resource/mousseron.png", positions: [[-676.3, 271.5], [-667.8, 264], [-686.3, 260.8], [-706.3, 253.5], [-632.8, 247.3], [-601.3, 229.5], [-577.5, 242.8], [-553.5, 237.3], [-491.8, 177.8], [-480.5, 192.5], [-459.8, 225.8], [-440.3, 230.3], [-420.3, 202.8], [-408.3, 178.8]] },
    "Austernpilz": { icon: "resource/pleurote.png", positions: [[-220.5, 355.3], [-207.5, 352.6], [-145.3, 303], [-162.5, 296], [-190.5, 294.3], [-210.3, 301.8], [-221.3, 310], [-214, 421.1], [-196.1, 428.4], [-174.4, 399.8], [-212.6, 470.8], [-232.5, 522.3], [-205.8, 512.4], [-194.9, 526.1], [-169, 510.6], [-167.9, 533.9], [-186, 547.6], [-189.3, 583.9]] }
};

// 8. FISCHLISTE
const fishList = [
    {name:"Ukelei", bg:"condition/ablette_lieu.png", cond:"condition/ablette_meteo.png", heure:"condition/ablette_heure.png"},
    {name:"Schlammbarsch", bg:"condition/acantharchus_pomotis_lieu.png", cond:"condition/acantharchus_pomotis_meteo.png", heure:"condition/acantharchus_pomotis_heure.png"},
    ...
    {name:"Rotstreifen-Killifisch", bg:"condition/aphyosemion_striatum_lieu.png", cond:"condition/aphyosemion_striatum_meteo.png", heure:"condition/aphyosemion_striatum_heure.png"},
    ...
    {name:"Komet-Goldfisch", bg:"condition/comete_coussut_lieu.png", cond:"condition/comete_coussut_meteo.png", heure:"condition/comete_coussut_heure.png"},
    ...
    {name:"Graubarsch", bg:"condition/pagellus_bogaraveo_lieu.png", cond:"condition/pagellus_bogaraveo_meteo.png", heure:"condition/pagellus_bogaraveo_heure.png"},
    ...
    {name:"Zwergtintenfisch", bg:"condition/pieuvre_naine_atlantique_lieu.png", cond:"condition/pieuvre_naine_atlantique_meteo.png", heure:"condition/pieuvre_naine_atlantique_heure.png"},
    ...
    {name:"Flusskugelfisch", bg:"condition/poissonglobe_de_riviere_lieu.png", cond:"condition/poissonglobe_de_riviere_meteo.png", heure:"condition/poissonglobe_de_riviere_heure.png"},
    ...
    {name:"Meerbarbe", bg:"condition/rouget_barbet_lieu.png", cond:"condition/rouget_barbet_meteo.png", heure:"condition/rouget_barbet_heure.png"},
    ...
    {name:"Europäischer Wels", bg:"condition/silure_europeen_lieu.png", cond:"condition/silure_europeen_meteo.png", heure:"condition/silure_europeen_heure.png"},
...
// 9. INSEKTENLISTE
const bugList = [
    {name:"Erdhummel", bg:"condition/abeille_a_queue_blanche_lieu.png", cond:"condition/abeille_a_queue_blanche_meteo.png", heure:"condition/abeille_a_queue_blanche_heure.png"},
    ...
    {name:"Violette Holzbiene", bg:"condition/abeille_charpentiere_violette_lieu.png", cond:"condition/abeille_charpentiere_violette_meteo.png", heure:"condition/abeille_charpentiere_violette_heure.png"},
    {name:"Chinesischer Mondspinner", bg:"condition/actias_neidhoederi_lieu.png", cond:"condition/actias_neidhoederi_meteo.png", heure:"condition/actias_neidhoederi_heure.png"},
    ...
    {name:"Tiger-Bockkäfer", bg:"condition/capricorne_tigre_lieu.png", cond:"condition/capricorne_tigre_meteo.png", heure:"condition/capricorne_tigre_heure.png"},
    ...
    {name:"Geflügelte Heuschrecke", bg:"condition/criquet_a_ailes_reticulees_lieu.png", cond:"condition/criquet_a_ailes_reticulees_meteo.png", heure:"condition/criquet_a_ailes_reticulees_heure.png"},
    {name:"Dickbeinig Heuschrecke", bg:"condition/criquet_aux_pattes_massives_lieu.png", cond:"condition/criquet_aux_pattes_massives_meteo.png", heure:"condition/criquet_aux_pattes_massives_heure.png"},
    ...
    {name:"Grille", bg:"condition/grillon_lieu.png", cond:"condition/grillon_meteo.png", heure:"condition/grillon_heure.png"},
    ...
    {name:"Wegerich-Scheckenfalter", bg:"condition/melitee_leopard_lieu.png", cond:"condition/melitee_leopard_meteo.png", heure:"condition/melitee_leopard_heure.png"},
    ...
    {name:"Weiße Hexeneule", bg:"condition/Papillon_sorcière_blanche_lieu.png", cond:"condition/Papillon_sorcière_blanche_meteo.png", heure:"condition/Papillon_sorcière_blanche_heure.png"},
    ...
    {name:"Feuerwanze", bg:"condition/pyrrhocoris_apterus_lieu.png", cond:"condition/pyrrhocoris_apterus_meteo.png", heure:"condition/pyrrhocoris_apterus_heure.png"},
    ...
    {name:"Rosa Heuschrecke", bg:"condition/sauterelle_rose_lieu.png", cond:"condition/sauterelle_rose_meteo.png", heure:"condition/sauterelle_rose_heure.png"},
    ...
    {name:"Violetter Waldvogel", bg:"condition/Vanesse_violette_lieu.png", cond:"condition/Vanesse_violette_meteo.png", heure:"condition/Vanesse_violette_heure.png"}
];
...
const birdList = [
    ...
    {name:"Grünflügelara", bg:"condition/ara_rouge_et_vert_lieu.png", cond:"condition/ara_rouge_et_vert_meteo.png", heure:"condition/ara_rouge_et_vert_heure.png"},
    ...
    {name:"Rotbauchgimpel", bg:"condition/bouvreuil_a_ventre_rouge_lieu.png", cond:"condition/bouvreuil_a_ventre_rouge_meteo.png", heure:"condition/bouvreuil_a_ventre_rouge_heure.png"},
    {name:"Siebenfarbentangare", bg:"condition/calliste_septicolore_lieu.png", cond:"condition/calliste_septicolore_meteo.png", heure:"condition/calliste_septicolore_heure.png"},
    {name:"Weißkopf-Ruderente", bg:"condition/canard_a_tete_blanche_lieu.png", cond:"condition/canard_a_tete_blanche_meteo.png", heure:"condition/canard_a_tete_blanche_heure.png"},
    ...
    {name:"Diamantfasan", bg:"condition/faisan_a_ventre_blanc_lieu.png", cond:"condition/faisan_a_ventre_blanc_meteo.png", heure:"condition/faisan_a_ventre_blanc_heure.png"},
    ...
    {name:"Helmspecht", bg:"condition/grand_pic_lieu.png", cond:"condition/grand_pic_meteo.png", heure:"condition/grand_pic_heure.png"},
    ...
    {name:"Goldhaubengärtner", bg:"condition/jardinier_a_tete_jaune_lieu.png", cond:"condition/jardinier_a_tete_jaune_meteo.png", heure:"condition/jardinier_a_tete_jaune_heure.png"},
    ...
    {name:"Gilbufertyrann", bg:"condition/moucherolle_a_ventre_jaune_lieu.png", cond:"condition/moucherolle_a_ventre_jaune_meteo.png", heure:"condition/moucherolle_a_ventre_jaune_heure.png"},
    ...
    {name:"Ährenträgerpfau", bg:"condition/paon_vert_lieu.png", cond:"condition/paon_vert_meteo.png", heure:"condition/paon_vert_heure.png"},
    ...
    {name:"Orangebauch-Fruchttaube", bg:"condition/pigeon_aux_fruits_dor_lieu.png", cond:"condition/pigeon_aux_fruits_dor_meteo.png", heure:"condition/pigeon_aux_fruits_dor_heure.png"},
    {name:"Gelbaugenseetaucher", bg:"condition/pigeon_aux_yeux_jaunes_lieu.png", cond:"condition/pigeon_aux_yeux_jaunes_meteo.png", heure:"condition/pigeon_aux_yeux_jaunes_heure.png"},
...
const QUIZ_DATA = [
    ...
    { q: "Wo findet man den Schlammbarsch?", o: ["Ruhiges Meer", "Waldsee", "Aurora-Fluss"], a: 0 },
    { q: "Welcher NPC verwaltet die Sammlung?", o: ["Der Sammler", "Bob", "Massimo"], a: 0 },
    { q: "Welches Wetter erzeugt einen Regenbogen?", o: ["Sturm", "Nebel", "Sonne nach Regen"], a: 2 },
    { q: "Wo ist das Fischerdorf?", o: ["Nordosten", "Südwesten", "Osten"], a: 1 },
    { q: "Wann erscheint der Chinesische Mondspinner?", o: ["Morgens", "Tagsüber", "Nachts"], a: 2 },
    { q: "Wo lebt das Capybara?", o: ["Die Ruinen", "Sprungbrett", "Strand"], a: 0 },
    { q: "Wer verkauft Tiere (Hunde)?", o: ["Vernie", "Frau Joan", "Andrew"], a: 1 },
    { q: "Wo fängt man den Riemenfisch?", o: ["Flüsse", "Seen", "Ozean"], a: 2 },
    { q: "Wo ist das Thermalgebiet?", o: ["Im Norden", "Im Süden", "Im Westen"], a: 0 },
    { q: "Wo lebt der Nashornkäfer?", o: ["Ostkai", "Feld", "Wald"], a: 0 },
    { q: "Was ist der Lear-Ara?", o: ["Fisch", "Insekt", "Vogel"], a: 2 },
    { q: "Wo lebt der Schmetterlingskarpfen?", o: ["Süßwasser", "Salzwasser", "Wiesensee"], a: 2 },
    { q: "Wo ist NPC Will?", o: ["Am Meer", "In den Bergen", "Im Wald"], a: 0 },
    { q: "Welche Farbe hat der FISCHE-Knopf?", o: ["Grün", "Blau", "Orange"], a: 1 },
    { q: "Wo lebt die Hummel?", o: ["Seen", "Blumenfelder", "Höhlen"], a: 1 },
    { q: "Wo ist der Otter?", o: ["Leuchtturm", "Fischerdorf", "Ruinen"], a: 1 },
    { q: "Wo lebt der Panda in der Nähe?", o: ["Sprungbrett", "Dorf", "Kai"], a: 0 },
    { q: "Wo lebt der Stint?", o: ["Wiesensee", "Oberer Waldsee", "Ozean"], a: 0 },
    { q: "Wo ist Annie?", o: ["Zentralplatz", "Strand", "Wald"], a: 0 },
    { q: "Wo lebt das Lama?", o: ["Violetter Strand", "Berg", "Fluss"], a: 0 },
    { q: "Bewertung der Karte?", o: ["5", "0", "20"], a: 2 },
    { q: "Wo lebt der Blaue Edelkrebs?", o: ["Waldsee", "Ozean", "Ruhiges Meer"], a: 0 },
    { q: "Wo ist der Walberg?", o: ["Süden", "Norden", "Westen"], a: 2 },
    { q: "Wozu dient Maptopia?", o: ["Items verkaufen", "Ressourcen finden", "Das Spiel ersetzen"], a: 1 },
    { q: "Was ist die Bachstelze?", o: ["Vogel", "Fisch", "Bewohner"], a: 1 },
    { q: "Wo lebt der Hirsch?", o: ["Strand", "Eichenwald", "Stadt"], a: 1 },
    { q: "Was ist der Zitronenfalter?", o: ["Frucht", "Insekt", "Fisch"], a: 1 },
    { q: "Wo ist der Ostkai?", o: ["Norden", "Osten", "Süden"], a: 1 },
    { q: "Was ist Bob?", o: ["Tier", "NPC", "Ort"], a: 1 }
];
